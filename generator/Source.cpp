...
void ShapesApp::BuildDescriptorHeaps()
{
	...
	// Need aCBV descriptot for each object for each frame resource,
	// +1 for the perPass CBV for each frame resource.
	UINT numDescriptors = (objCount + 1) * gNumFrameResources;

	// Sace an offset to the start of the pass CBVs. These are the last 3 descriptors.
...
void ShapesApp::BuildShapeGeometry()
{
	...
	// 
	// We are concatenating all the geometry into one big vertex/index buffer. So we
